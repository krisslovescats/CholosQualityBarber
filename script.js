...
// Datos de paquetes
const paquetes = {
    'paquete-basico': { nombre: 'Paquete Básico', precio: 12000 },
                        ...
                        ${itinerario.map(item => `
                            <div class="paso-item">
                                ...
                                <div class="paso-contenido">
                                    ...
                                    <span class="paso-duracion">⏱️ ${item.duracion}</span>
                                </div>
                            </div>
                        `).join('')}
                    </div>
                                ...
                                <div class="slots-disponibles">
                                    ${dia.slots.map(slot => `
                                        <div class="slot ${slot.disponible ? 'disponible' : 'ocupado'}">
                                            ...
                                            <span class="estado">${slot.disponible ? '✅ Available' : '❌ Ocupado'}</span>
                                        </div>
                                    `).join('')}
                                </div>
                            </div>
